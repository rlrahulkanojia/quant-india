...
import { BarChart3, Bot, Moon, Sun, Plus, Trash2, Pencil, MessageSquare, ChevronsLeft, ChevronsRight, Settings, Layers, Loader2, Wallet, ArrowLeftRight, Eye, Activity } from "lucide-react";
...
const NAV = [
  ...
  { to: "/shadow", icon: Eye, label: "Shadow" },
